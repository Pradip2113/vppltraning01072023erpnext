...
class Supplier(TransactionBase):
	...
	def before_save(self):
		# frappe.msgprint("this is before_save")
		# self.farm_reg()
		if not self.on_hold:
			self.hold_type = ""
			self.release_date = ""
	...
	# @frappe.whitelist()
	# def farm_reg(self):
	# 	frappe.msgprint("this is farm_reg")
	# 	frappe.msgprint(self.name)
	# 	p=self.name
	# 	if(self.supplier_type=="Farmer"):
	# 		m=frappe.new_doc('Farmer List')
	# 		m.supplier_type=self.supplier_type
	# 		m.supplier_name=self.supplier_name
	# 		m.mobile_number=self.mobile_number
	# 		m.aadhaar_number=self.aadhaar_number
	# 		m.pan_number=self.pan_number
	# 		m.date_of_birth=self.date_of_birth
	# 		m.caste=self.caste
	...
	# 		m.is_transporter=self.is_transporter
	# 		m.image=self.image
	# 		m.is_member=self.ismember
	# 		m.is_harvester=self.isharvester
	# 		m.crop_type=self.crop_type
	# 		m.village=self.village
	# 		m.circle_office=self.circle_office
	# 		m.taluka=self.taluka
	# 		m.aadhaar_card=self.aadhaar_card
	# 		m.bank_passbook=self.bank_passbook
	# 		m.pan_card=self.pan_card
	# 		m.bank_details=self._bank_details
	# 		m.name=p
	# 		m.insert()
	# 		m.name=p
	# 		m.save()
