...
class PaymentEntry(AccountsController):
	# @frappe.whitelist()
	# def eeeuu(self):
	# 	doc = frappe.db.get_list('Advance Request',filters={'name':self.payment_request},fields=["name", "transporter_code","advance_amount","transporter_name"])
	# 	for s in doc:
	# 		self.party_type = "Supplier",
	# 		self.payment_type = "Pay",
	# 		self.party = s.transporter_code,
	# 		self.party_name = s.transporter_name,
